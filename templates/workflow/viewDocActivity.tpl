	...
	$(document).ready(function (){
		...
		$('#myDocuments').tablesorter ({
	        ...
	        widgetOptions: {
	            ...
	            pager_storageKey: 'tablesorter-pager-docactivity',
	            pager_ajaxUrl: '/workflow/view_doc_activity.php?doc_id={$doc_id}&ajax=1&pagenum={literal}{page}{/literal}&{literal}{filterList:filter}{/literal}&{literal}{sortList:column}{/literal}&pagesize={literal}{size}{/literal}',
...
<div style="padding:1%">
	...
	{else}
		No document activity available.
	{/if}
</div>