...
# temp file
writehash("$ENV{'JVS_ROOT'}/conf/scjdivassignhash.txt",\%divassign);
...
# temp file
writehash("$ENV{'JVS_ROOT'}/conf/scjudgelisthash.txt",\%judgelist);
...
open OUTFILE,">$ENV{'JVS_ROOT'}/conf/scjudgepage.conf";
