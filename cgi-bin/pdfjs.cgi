...
<html dir="ltr" mozdisallowselectionprint moznomarginboxes>
  ...
  .scrollbarHidden #viewerContainer {
          ...
          <div id="toolbarContainer">
            <div id="toolbarViewer">
              <div id="toolbarViewerLeft">
                ...
                <button id="viewFind" class="toolbarButton group hiddenSmallView" style="display: none" title="Find in Document" tabindex="12" data-l10n-id="findbar">
...
#mozPrintCallback-shim .progress-actions {
  ...
  if(window.location.hash.indexOf("toolbar=0") > 0){
    ...
    document.getElementById('viewerContainer').setAttribute('style', 'top: 0px;');
  }

  if(window.location.hash.indexOf("sidebar=1") > 0){
    document.getElementById('outerContainer').classList.add('sidebarOpen');
  }

  if(window.location.hash.indexOf("scrollbar=0") > 0){
    document.getElementById('mainContainer').classList.add('scrollbarHidden');
  }
