...
(function($) {
    ...
    CKEDITOR.plugins.add( 'footnotes', {
        ...
        init: function(editor) {
            ...
            // Add some CSS tweaks:
            var css = '.footnotes{background:#FFFFFF; padding-top:5%;} .footnotes cite{font-style: normal;}';
            CKEDITOR.addCss(css);
        ...
        buildFootnote: function(footnote_id, footnote_text, data, editor) {
            ...
            if (data && data.occurrences[footnote_id] == 1) {
                ...
                var i = 0
                  ...
                  , n = l;
                for (i; i < l; i++) {
                    links += '<a style="text-decoration:none;color:#000000;" href="#footnote-marker' + prefix + '-' + order + '-' + (i + 1) + '">' + letters.charAt(i) + '</a>';
                    if (i < l-1) {
                        links += ', ';
                    } else {
                        links += ' ';
        ...
        addFootnote: function(footnote, editor) {
            ...
            if ($footnotes.length == 0) {
                ...
                var container = '<section class="footnotes">_____________________<br/><ol style="font-size:0.8em">' + footnote + '</ol></section>';
        ...
        reorderMarkers: function(editor) {
            ...
            $markers.each(function(){
                ...
                var marker = '<a style="text-decoration:none;color:#000000;" href="#footnote' + prefix + '-' + n + '" id="footnote-marker' + prefix + '-' + marker_ref + '" rel="footnote">' + n + '</a>';
                $(this).html(marker);
            });
