                            ...
                            setup: function( element ) {
                                ...
                                if ($footnotes.length > 0) {
                                    if ($el.find('p').length == 0) {
                                        $el.append('<p style="margin-bottom: 10px;"><strong>OR:</strong> Choose footnote to apply:</p><ol class="footnotes_list"></ol>');
                                    } else {
                                        $el.find('ol').empty();
                                    }
            ...
            onShow: function() {
                ...
                CKEDITOR.replaceAll( function( textarea, config ) {
                    ...
                    config.toolbarGroups = [
                        { name: 'editing',     groups: [ 'undo', 'selection', 'spellchecker' ] },
                    ...
                    config.removeButtons = 'Format,Save,NewPage,Preview,Templates,Language,Flash,IFrame,Image,Subscript,Superscript,Smiley,Font,ShowBlocks,SpecialChar,HorizontalRule,Link,Unlink,Anchor,Table,HiddenField,Button,Select,Textarea,TextField,Form,Checkbox,Radio,DocProps,Print,About,Source,Find,Replace,Maximize';
